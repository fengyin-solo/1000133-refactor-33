...
const {
  ...
  columns,
  endpoint: '/api/waybill',
  loadFailedMessage: '冷链运单列表读取失败',
  loadErrorMessage: '运单管理列表读取失败',
  actionFailedMessage: '运单管理动作未生效，请稍后重试',
  actionErrorMessage: '运单管理操作失败',
  notReadyMessage: '冷链运单登记入口尚未接入审批流',
})
</script>
